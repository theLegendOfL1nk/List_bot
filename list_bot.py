...
INITIAL_DATA_LIST = [
  ...
  ['Ant Egg', 'tianleshan', 11, 1757036931],
  ['Antennae', 'Manfred', 9, 1757036931],
  ['Battery', 'Umit', 8, 1757036931],
  ['Beetle Egg', 'hqyx', 11, 1757036931],
  ['Bone', 'HUDUMOC', 10, 1757036931],
  ['Bubble', 'Recon', 6, 1757036931],
  ['Cactus', 'tianleshan', 7, 1757036931],
  ['Card', 'hqyx', 6, 1757036931],
  ['Claw', 'gainer', 7, 1757036931],
  ['Clover', '-Sam8375', 27, 1757036931],
  ['Coin', 'WTJ', 27, 1757036931],
  ['Corn', '-Sam8375', 6, 1757036931],
  ['Corruption', 'Pehiley', 6, 1757036931],
  ['Dandelion', 'FREEDOM08', 6, 1757036931],
  ['Dark Mark', 'Craft_Super', 6, 1757036931],
  ['Dice', 'Pehiley', 6, 1757036931],
  ['Fang', 'hqyx', 8, 1757036931],
  ['Faster', '-Sam8375', 9, 1757036931],
  ['Glass', '-Sam8375', 23, 1757036931],
  ['Heavy', 'asds', 6, 1757036931],
  ['Iris', 'Craft_Super', 9, 1757036931],
  ['Jelly', 'tarou9n', 7, 1757036931],
  ['Leaf', 'Etin', 7, 1757036931],
  ['Light', 'Bibi', 7, 1757036931],
  ['Light Bulb', 'BaiLin2', 8, 1757036931],
  ['Lightning', 'Wolxs', 6, 1757036931],
  ['Magic Cactus', 'Pehiley', 6, 1757036931],
  ['Magic Leaf', 'Manfred', 6, 1757036931],
  ['Magic Missile', 'Pehiley', 6, 1757036931],
  ['Magic Stick', 'Pehiley', 6, 1757036931],
  ['Mana Orb', 'BONER_ALERT', 6, 1757036931],
  ['Mecha Antennae', 'Mr_Alex', 6, 1757036931],
  ['Mecha Missile', 'Mario', 6, 1757036931],
  ['Missile', 'Missile', 8, 1757036931],
  ['Mjölnir', 'Manfred', 14, 1757036931],
  ['Mysterious Relic', 'gujiga', 6, 1757036931],
  ['Mysterious Stick', 'BaiLin2', 6, 1757036931],
  ['Orange', 'Solar', 9, 1757036931],
  ['Pearl', 'gachanchall', 6, 1757036931],
  ['Peas', 'WTJ', 6, 1757036931],
  ["Pharaoh's Crown", 'Missile', 51, 1757036931],
  ['Pincer', 'Avril', 8, 1757036931],
  ['Poker Chip', 'PlayFlorrio', 12, 1757036931],
  ['Poo', 'gainer', 15, 1757036931],
  ['Privet Berry', 'Avril', 9, 1757036931],
  ['Rice', 'Manfred', 6, 1757036931],
  ['Rock', 'Wolxs' , 6,1757036931],
  ['Salt', 'tarou9n', 6, 1757036931],
  ['Sand', 'Zorat', 13, 1757036931],
  ['Starfish', 'CarrotJuice', 7, 1757036931],
  ['Talisman of Evasion', 'gainer', 9, 1757036931],
  ['Totem', 'BONER_ALERT', 6, 1757036931],
  ['Triangle', 'gujiga', 8, 1757036931],
  ['Wax', 'ProH', 6, 1757036931],
  ['Web', 'Manfred', 6, 1757036931],
  ['Wing', 'gainer', 25, 1757036931],
  ['Yucca', 'Pehiley', 12, 1757036931]
]
